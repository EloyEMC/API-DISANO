...
class TestV2Endpoints:
    ...
    def test_v2_detail_endpoint_not_found(self, client):
        ...
        if response.status_code == 404:
            ...
            assert "not found" in detail.lower() or "no encontrado" in detail.lower(), (
    ...
    def test_v2_endpoints_use_producto_service(self):
        ...
        for endpoint in v2_endpoints:
            ...
            assert "service" in params, (
                f"{endpoint.__name__} should have service parameter"
            )
