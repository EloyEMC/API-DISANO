...
class TestProductosRouterEndpoints:
    ...
    def test_productos_has_get_all_endpoint(self):
        ...
        # Assert - Buscar decorador base sin parámetros
    ...
    def test_productos_has_get_by_codigo_endpoint(self):
        ...
        # Assert
        assert "@router.get" in content and "/{codigo}" in content
    ...
    def test_productos_has_get_by_marca_endpoint(self):
        ...
        # Assert
        assert "@router.get" in content and "/marca/" in content
    ...
    def test_productos_has_v2_list_endpoint(self):
        ...
        # Assert
        assert "@router.get" in content and "/v2/list" in content
    ...
    def test_productos_has_v2_get_by_codigo_endpoint(self):
        ...
        # Assert
        assert "@router.get" in content and "/v2/" in content
    ...
    def test_productos_has_patch_precio_endpoint(self):
        ...
        # Assert
        assert "@router.patch" in content and "precio" in content
    ...
    def test_productos_has_test_v2_endpoint(self):
        ...
        # Assert
        assert "@router.get" in content and "test-v2" in content
    ...
    def test_productos_has_v2_marca_endpoint(self):
        ...
        # Assert
        assert "@router.get" in content and "/v2/marca" in content
    ...
    def test_productos_has_v2_familia_endpoint(self):
        ...
        # Assert
        assert "@router.get" in content and "/v2/familia" in content
