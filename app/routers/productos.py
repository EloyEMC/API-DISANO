...
def map_row_to_v2(row: sqlite3.Row) -> dict:
    ...
    """
    # Convertir Row a dict primero para poder usar .get()
    row_dict = dict(row)

    return {
        "codigo": row_dict.get("CÓDIGO"),
        "codigo_web": row_dict.get("[CÓDIGO WEB]"),
        "marca": row_dict.get("MARCA"),
        "referencia": row_dict.get("REFERENCIA"),
        "ean13": row_dict.get("[EAN 13]"),
        "descripcion": row_dict.get("DESCRIPCION"),
        "descripcion_corta": row_dict.get("descripcion_corta"),
        "pvp": row_dict.get("PVP_26_01_26"),
        "pvp_by_date": row_dict.get("PVP_26_01_26"),
        "up_log": row_dict.get("[U.P.LOG]"),
        "u_caja": row_dict.get("[U.CAJA]"),
        "dto": row_dict.get("[DTO.]"),
        "clase_etim": row_dict.get("[CLASE ETIM]"),
        "peso_bruto_kg": row_dict.get("[Peso bruto KG]"),
        "peso_bruto_gr": row_dict.get("[Peso bruto GR]"),
        "peso_neto_kg": row_dict.get("[Peso neto KG]"),
        "peso_neto_gr": row_dict.get("[Peso neto GR]"),
        "longitud_m": row_dict.get("[Longitud M]"),
        "longitud_mm": row_dict.get("[Longitud MM]"),
        "ancho_m": row_dict.get("[Ancho M]"),
        "ancho_mm": row_dict.get("[Ancho MM]"),
        "alto_m": row_dict.get("[Alto M]"),
        "altura_mm": row_dict.get("[Altura MM]"),
        "volumen_dm3": row_dict.get("[Volumen DM3]"),
        "cm3": row_dict.get("CM3"),
        "serie_familia_1": row_dict.get("Serie_familia_1"),
        "familia_web": row_dict.get("Familia_WEB"),
        "familia_catalogo": row_dict.get("Familia_Catalogo"),
        "familia_catalogo_ptl": row_dict.get("Familia_Catalogo_PTL"),
        "imagen": row_dict.get("imagen"),
        "url_ficha_tec": row_dict.get("Url_ficha_tec"),
        "descontinuado": bool(row_dict.get("descontinuado", 0)),
        "img_url": row_dict.get("img_url"),
        "raee_a": row_dict.get("RAEE_A"),
        "raee_l": row_dict.get("RAEE_L"),
        "raee_t": row_dict.get("RAEE_T"),
        "bc3_descripcion_corta": row_dict.get("bc3_descripcion_corta"),
        "bc3_descripcion_larga": row_dict.get("bc3_descripcion_larga"),
